...
@alkamin/indigo/1.6.0 linux-x64 node-v12.22.4
$ indigo --help [COMMAND]
USAGE
  $ indigo COMMAND
...
...
_See code: [src/commands/generate/index.ts](https://github.com/alkamin/indigo/blob/v1.6.0/src/commands/generate/index.ts)_
...
_See code: [src/commands/new/index.ts](https://github.com/alkamin/indigo/blob/v1.6.0/src/commands/new/index.ts)_
<!-- commandsstop -->
