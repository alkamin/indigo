...
@alkamin/indigo/1.1.19 linux-x64 node-v12.22.1
$ indigo --help [COMMAND]
USAGE
  $ indigo COMMAND
...
...
_See code: [src/commands/new/index.ts](https://github.com/alkamin/indigo/blob/v1.1.19/src/commands/new/index.ts)_
<!-- commandsstop -->
