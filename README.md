...
@alkamin/indigo/1.3.0 linux-x64 node-v12.22.4
$ indigo --help [COMMAND]
USAGE
  $ indigo COMMAND
...
...
_See code: [src/commands/new/index.ts](https://github.com/alkamin/indigo/blob/v1.3.0/src/commands/new/index.ts)_
<!-- commandsstop -->
